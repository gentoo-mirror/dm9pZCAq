...
SRC_URI="
	...
	zsh-completion? (
		https://github.com/dbrgn/${PN}/releases/download/v${PV}/completions_zsh
			-> ${P}.zsh
	)
"
...
src_install() {
	...
	use bash-completion && newbashcomp "bash_${PN}" "${PN}"
